...
Public Class AcdLayer
    ...
    Private c_lTR As LayerTableRecord
    Private c_ltrID As String
    ...
    Private c_HasVPoverrides As Dictionary(Of ObjectId, Boolean)
    Private c_vpOverrides As Dictionary(Of ObjectId, LayerViewportProperties)
    Private c_HasOverrides As Boolean
    ...
    Public Sub New(nm As String)
        ...
        Using actrans As Transaction = dwgDB.TransactionManager.StartTransaction
            Dim lTable As LayerTable = actrans.GetObject(dwgDB.LayerTableId, OpenMode.ForRead)
            Dim ltr As LayerTableRecord = actrans.GetObject(lTable(nm), OpenMode.ForRead)
            With ltr
                c_nm = .Name
    ...
    '<XmlAttribute("IsByAlpha")>
    'Public Property IsByAlpha() As Boolean
    '    Get
    '        Return c_isByAlpha
    '    End Get
    '    Set(ByVal value As Boolean)
